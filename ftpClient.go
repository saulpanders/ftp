/*
	@saulpanders
	FTP Client
	ftpclient.go -- simple ftp client (to be used w ftpServer.go)

	inpired by "network programming with go"
*/
...
//Strings used by user interface
const (
	uiDir  = "dir"
	uiCd   = "cd"
	uiPwd  = "pwd"
...
//strings used across network ftp app
const (
	DIR = "DIR"
	CD  = "CD"
	PWD = "PWD"
